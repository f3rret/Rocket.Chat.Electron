...
type ChannelToArgsMap = {
  ...
  'downloads/show-downloads-path': () => void;
  'downloads/remove-all-downloads': ()=> void;
  'downloads/set-downloads-path': () => void;
  'downloads/show-in-folder': (itemId: Download['itemId']) => void;
  'downloads/run-downloaded': (itemId: Download['itemId']) => void;
  ...
  'p2p-download': (signal: any) => void;
  'p2p-upload': (param: any) => void;
};
