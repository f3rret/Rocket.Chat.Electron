...
const onwarn = warning => {
  ...
  if (
    ...
    && !warning.importer.indexOf(path.normalize('src/downloads/spf'))
  ) {
    return
  }
...
export default [
  ...
  },
  {
    ...
    plugins: [
      ...
      commonjs({ //my
		 /* include: ['/node_modules/from2', /simple-peer-files/],
		  dynamicRequireTargets: [
			'node_modules/readable-stream/lib/*.js',
			'node_modules/from2/node_modules/readable-stream/lib/*.js'
		  ]*/
	  }),
      run(),
    ],
